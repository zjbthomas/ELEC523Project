% obtained from https://www.biomecardio.com/matlab/otsu.m

function [IDX,sep] = OtsuNCore(I,n)
...
%   Notes:
%   -----
%   It should be noticed that the thresholds generally become less relevant
...
%
%   See also GRAYTHRESH, IM2BW, OTSUTHRESH
%
%   -- Damien Garcia -- 2007/08, last update 2017/08
%   website: <a
...
elseif n>255
    % Note that it does not make sense to have a great n number
    % In practice, n>>4 is not recommended
    n = 255;
...
isRGB = ndims(A)==3 && size(A,3)==3 && (isfloat(A) || isa(A,'uint8') || isa(A,'uint16'));
